...
class Pilot (Ckpt.Ckpt):  # subclass of the class Ckpt in the file Ckpt
    ...
    def __init__(self, tsk='MP4a', rc=False, gui=False, desired_altitude_change=None, desired_gamma=None, desired_velocity=None):
        ...
        self.desired_altitude = desired_altitude_change
    ...
    def ai(self, fDat, fCmd):
        ...
        if self.run_condition:
            # Implementing a simple pitch PID
      
            print("Setting pitch to ", commanded_pitch)
